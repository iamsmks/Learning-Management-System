...
<%
    try {
        ...
        out.print("<h1>Attendance List</h1>");
        out.print("<table border='1'>");
        out.print("<tr><th>ID</th><th>Name</th><th>Status</th><th>Date</th></tr>");
        while(rs.next()) {
            out.print("<tr><td>" + rs.getInt("id") + "</td><td>" + rs.getString("name") + "</td><td>" + rs.getString("status") + "</td><td>" + rs.getDate("date") + "</td></tr>");
        }
        out.print("</table>");
        out.print("</div>");
    }
